...
## Gerador de SVG de debug por zona da FASE 01 (headless, ZERO GPU).
##
...
const _AREA_TITLE := {
	"Z1": "Z1 — início / armadura secreta", "Z2": "Z2 — Rio de Lava",
	"Z3": "Z3 — maré de lava", "Z4": "Z4 — shaft de wall-jump + rota secreta", "Boss": "Boss — Ignarath",
}
...
func _run() -> void:
	...
	_write_legend()
	_write_index()
	print("zone_debug_01: concluído. %d SVG + legenda + index em %s" % [made, _OUT_DIR])
