...
| **Galerix** | Vento | Falcão tempestade | `"Galerix storm hawk boss, sleek aerodynamic bird of prey, teal and white feathered armor, streamlined wind turbine wings, flowing energy feather trails, sharp curved beak, fierce attack dive posture, Mega Man X style pixel art, side view"` |
...
| **Luxar** | Luz | Leão solar | `"Luxar solar lion boss, majestic armored lion, radiant white and gold mane with light rays, blinding energy core in chest, halo crown of sunrays, golden claws, proud regal battle stance, Mega Man X style pixel art, side view"` |
...
| Galerix | `"swift gliding walk cycle, storm hawk, wind energy trailing"` | `"dramatic entrance, storm hawk diving in at high speed and landing in battle stance, facing camera"` |
...
| Luxar | `"regal powerful walking cycle, solar lion, mane radiating light"` | `"dramatic entrance, solar lion descending in pillar of light, landing in proud stance, facing camera"` |
