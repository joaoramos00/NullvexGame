...
const _HITBOX_ENTITIES: Array = [
    ...
    {"name": "Cryovex", "path": "res://characters/bosses/cryovex.tscn", "group": "Bosses", "kind": "Bosses", "stage": "Stage 02", "anims": [
        {"label": "Walk",        "path": "res://characters/bosses/cryovex/cryovex_walk_east.png",       "frames": 9},
        {"label": "Enter",       "path": "res://characters/bosses/cryovex/cryovex_entry.png",           "frames": 7},
        {"label": "GatherEnergy","path": "res://characters/bosses/cryovex/cryovex_gather_east.png",     "frames": 5},
        {"label": "Bite",        "path": "res://characters/bosses/cryovex/cryovex_bite_east.png",       "frames": 9},
        {"label": "IcyBlast",    "path": "res://characters/bosses/cryovex/cryovex_iceblast_east.png",   "frames": 9},
        {"label": "TakeHit",     "path": "res://characters/bosses/cryovex/cryovex_takehit_east.png",    "frames": 9},
    ...
    {"name": "Terragor", "path": "res://characters/bosses/terragor.tscn", "group": "Bosses", "kind": "Bosses", "stage": "", "anims": [
        {"label": "Walk",  "path": "res://characters/bosses/terragor/terragor_walk_east.png",  "frames": 9},
        {"label": "Walk2", "path": "res://characters/bosses/terragor/terragor_walk2_east.png", "frames": 9},
        {"label": "Enter", "path": "res://characters/bosses/terragor/terragor_entry.png",      "frames": 9},
    ]},
...
class _PlatformView extends Control:
    ...
    # cols == 0 é o piso do controle "−": em vez de sumir o elemento (elem_last
    # coincide com a coluna da face, interceptado antes de chegar no ramo da
    # "ponta"), cols=0 cai pro nub mínimo de 1 coluna — só a ponta (topo+base),
    # sem miolo — igual ao Foothold de 1 tile já usado no jogo (Z4Foot1-5).
    func _wall_eff_cols() -> int:
    ...
    func _wall_tile_at(cc: int, r: int) -> Vector2i:
        ...
        var elem_last := 1 + _wall_eff_cols()
        if cc == 0:
    ...
    func _draw_wall() -> void:
        ...
        var x_out:  float = (2 + _wall_eff_cols()) * _TD if not mirror_hole else (g.x - 2 - _wall_eff_cols()) * _TD
...
func _refresh_tiles() -> void:
    ...
    cols_m.pressed.connect(func():
        var min_cols := 0 if pview.mode.begins_with("wall_") else 1
        if pview.cols > min_cols:
