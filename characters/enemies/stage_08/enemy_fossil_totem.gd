extends EnemyBase
class_name EnemyFossilTotem

# Totem fóssil fixo: não vira; atira ore_shard em intervalos quando o player
# entra na janela do lado configurado (face_dir).
...
func _fire() -> void:
	...
	proj.setup(Vector2(_direction * BOLT_SPEED, 0.0), BOLT_DAMAGE, "fossil_totem", 0.0, "ore_shard")
