...
class_name EnemyStoneGlider

# Planador de pedra flutuante: hover puro (sem mergulho) + tiro de stone_shot.
...
func _fire_bolt(target: Node2D) -> void:
	...
	proj.setup(dir * BOLT_SPEED, BOLT_DAMAGE, "stone_glider", 0.0, "stone_shot")
