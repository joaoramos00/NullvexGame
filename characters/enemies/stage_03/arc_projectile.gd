...
const TEX := {
	"arc_bolt": preload("res://characters/enemies/stage_03/arc_bolt.png"),
}

var projectile_velocity: Vector2 = Vector2(300.0, 0.0)
var damage: int = 6
var source_id: String = "stage03_arc"
var variant: String = "arc_bolt"
...
func setup(velocity_value: Vector2, damage_value: int, source_value := "stage03_arc",
		gravity_value := 0.0, variant_value := "arc_bolt") -> void:
