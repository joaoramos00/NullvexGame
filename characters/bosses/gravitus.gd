...
const _TEX_WALK_W := preload("res://characters/bosses/gravitus/gravitus_walk_west.png")
const _TEX_WALK_E := preload("res://characters/bosses/gravitus/gravitus_walk_east.png")
const _TEX_ENTRY  := preload("res://characters/bosses/gravitus/gravitus_entry.png")
